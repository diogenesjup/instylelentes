<!-- Right sidebar -->
          <div class="four columns">
              ...
              <form role="search" method="get" id="searchform" class="searchform" action="http://patientcc.com/">
  ...
  foreach ($categories as $cat) {
        ...
        echo '<li><a href="http://patientcc.com/insights-pcc/'.$cat->slug.'">'.$cat->name.'</a></li>';
        //echo '<br />';
...
?></ul>
               ...
               <div class="widget">
                    ...
                    <nav class="categories">
                         <ul>
                              <li><a href="http://patientcc.com/insights/">Abril 2016</a></li>
                         </ul>
                    </nav>
               </div>
          </div>